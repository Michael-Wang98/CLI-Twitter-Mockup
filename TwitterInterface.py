...
print("\nWelcome " + username + "\n")
options = ["Post", "Follow another user", "Follow a Topic", "Like or dislike a post", "Retweet", "Inspect a post", "Show all unread tweets", "exit"]
for x in options:
...
while ongoing:
    ...
    # print out the attributes of the tweet requested.
        ...
        if result(query(count(tweets.columns.tweetID, inspect))) == "1":
            print(" tweetID, airline_sentiment, airline_sentiment_confidence, negativereason, negativereason_confidence, topic,airline_sentiment_gold, userName, negativereason_gold, retweet_count, likes, post_day, post_month, post_year, tweetText")
